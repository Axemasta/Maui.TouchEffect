...
public partial class GameDevelopersViewModel(ILogger<GameDevelopersViewModel> logger) : ObservableObject
{
    ...
    private async Task DeveloperSelected(GameDeveloperDisplayItem? item)
    {
        ...
        await Shell.Current.DisplayAlertAsync($"Selected {item.Title}!", item.SubTitle, "OK");
    }
}
